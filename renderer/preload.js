...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  openNamemcCache: (opts) => ipcRenderer.invoke('open-namemc-cache', opts),
  ...
  fetchAvatar: (opts) => ipcRenderer.invoke('fetch-avatar', opts),
  ...
  readFileBase64: (opts) => ipcRenderer.invoke('read-file-base64', opts),
  scrapeNameMCSkin: (opts) => ipcRenderer.invoke('scrape-namemc-skin', opts),
  scrapeNamemcAllSkins: (opts) => ipcRenderer.invoke('scrape-namemc-all-skins', opts)
});
